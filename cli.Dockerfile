...
ADD "https://github.com/pluralsh/plural-cli/releases/download/${PLURAL_VERSION}/plural-cli_${PVERSION}_Linux_${TARGETARCH}.tar.gz" /
RUN tar -xzvf /plural-cli_${PVERSION}_Linux_${TARGETARCH}.tar.gz plural
